...
public class ScannerViewWide extends LinearLayout {
    ...
    public ScannerViewWide(Context context) {
        this(context, null);
    }

    public ScannerViewWide(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    @SuppressLint("ClickableViewAccessibility")
    public ScannerViewWide(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
