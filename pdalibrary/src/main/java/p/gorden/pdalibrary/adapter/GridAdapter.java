...
import p.gorden.pdalibrary.unity.Fun;
...
public class GridAdapter extends RecyclerView.Adapter<GridAdapter.GridViewHolder> {
    ...
    private ArrayList<Fun> list_function;
    ...
    public GridAdapter(Context context, ArrayList<Fun> list_function){
        this.context = context;
        this.list_function = list_function;
    }

    public void setList_function(ArrayList<Fun> list_function){
        this.list_function = list_function;
    }
